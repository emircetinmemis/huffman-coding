...
class HuffmanCoding:
	...
	def compress(self):
		...
		with open("L-1 mapping info.txt", "w+") as file:
	...
	def decompress(self, input_path):
		...
		with open("L-1 mapping info.txt", "r") as file :
			text = file.read().rstrip()
			reverse_mapping = eval(text)
...
"""
input_path = "L-1 sample.txt"
output_path = "L-1 sample.bin"
